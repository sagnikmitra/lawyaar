...
import { Shield, Award, LockKeyhole } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-semibold">LawYaar</span>
            </div>
            ...
            <div className="flex items-center space-x-4 pt-2">
              <div className="flex items-center text-xs text-neutral-300">
                ...
                <span>{t('footer.data_protected')}</span>
              </div>
              <div className="flex items-center text-xs text-neutral-300">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/services/family-law" className="text-neutral-300 hover:text-white text-sm">
                  {t('footer.family_law')}
                </Link>
              </li>
              <li>
                <Link to="/services/property-law" className="text-neutral-300 hover:text-white text-sm">
                  {t('footer.property_law')}
                </Link>
              </li>
              <li>
                <Link to="/services/criminal-law" className="text-neutral-300 hover:text-white text-sm">
                  {t('footer.criminal_law')}
                </Link>
              </li>
              <li>
                <Link to="/services/corporate-law" className="text-neutral-300 hover:text-white text-sm">
                  {t('footer.corporate_law')}
                </Link>
              </li>
              <li>
                <Link to="/services/civil-law" className="text-neutral-300 hover:text-white text-sm">
                  {t('footer.civil_law')}
                </Link>
              </li>
            </ul>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-medium mb-4">{t('footer.quick_links')}</h3>
            <ul className="space-y-2">
              <li>
          ...
          {/* Contact */}
          <div>
            <h3 className="text-lg font-medium mb-4">{t('footer.contact_us')}</h3>
            <ul className="space-y-2">
              <li className="text-neutral-300 text-sm">
                <strong>{t('footer.email')}:</strong> contact@lawyaar.com
              </li>
              <li className="text-neutral-300 text-sm">
                <strong>{t('footer.phone')}:</strong> +91 9876543210
              </li>
              <li className="text-neutral-300 text-sm">
                <strong>{t('footer.address')}:</strong> {t('footer.address_value')}
              </li>
            </ul>
        ...
        <div className="mt-8 pt-6 border-t border-primary-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-neutral-400">
              &copy; {new Date().getFullYear()} LawYaar. {t('footer.rights_reserved')}
            </p>
            <div className="mt-4 md:mt-0">
              <div className="flex space-x-6">
                ...
                <Link to="/cookies" className="text-sm text-neutral-400 hover:text-white">
                  {t('footer.cookies')}
                </Link>
              </div>
            </div>
